    ...
    <div className=" w-full  flex justify-center ">
      <div className="  w-full  flex flex-col justify-end">
        ...
        >
          ...
          {/*search box */}
          <div className="w-7/12 rounded-[0.5vh]  border-2 border-gray1">
            <input
              type="text"
              placeholder={
                languageIs
              ...
              className="w-full font-inter text-[13px] md:text-[16px] gl-text-[20px] xl:text-[25px] 2xl:text-[31px] text-black h-[30px] md:h-[40px] xl:h-[50px] 2xl:h-[60px]  active:outline-none indent-1 hover:outline-none focus:outline-none"
            />
          </div>
          {/*search dropdown */}
