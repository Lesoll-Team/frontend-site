    ...
    <div className={`${classNames} relative  `}>
      <div
        ...
        className="w-full font-semibold text-darkGreen text-md flex items-center justify-between
          focus:outline-lightGreen bg-white border-[3px]  rounded-xl p-3 space-x-4 cursor-pointer whitespace-nowrap"
      >
        {value || valueDefault}
        <div>
          <LuArrowLeftRight
            className={`text-darkGreen rotate-90 duration-150 ${
      ...
      {menuIsOpen && (
        <div
          className={`absolute animate-appearance-in z-10 w-[175px] mt-1 duration-200
