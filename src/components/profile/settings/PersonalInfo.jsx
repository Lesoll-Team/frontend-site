      ...
      <div className="w-full sm:max-w-[700px] mx-auto py-10 px-5 border-2 rounded-xl bg-white drop-shadow-lg">
        <form className="space-y-10" onSubmit={handleFormSubmit}>
          ...
          <div className="flex justify-start items-center relative   ">
            ...
            />
            <div className=" bg-lightGreen right-3 top-11 rounded-full w-10 h-10 flex justify-center items-center relative overflow- cursor-text overflow-hidden border-gray-300 ">
              <input
                type="file"
                // accept="image/"
