...
const BarFilter = ({
  ...
  return (
    <div className="relative md:py-8 py-4 w-full">
      <div
      ...
      >
        <div
         ...
         border-gray1 bg-white px-2 min-w-[200px] rounded-[0.6vw]"
        >
        ...
        <button
         ...
         md:border-[1px] border-0 md:border-gray1 rounded-[1vh] md:px-3 md:p-2 p-1 px-1 cursor-pointer"
