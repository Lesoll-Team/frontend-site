  ...
  return (
    ...
    <nav  className=" fixed top-0 h-24 left-0 right-0 z-50 md:h-20 flex items-center" >
      ...
      <div className=" mx-auto z-10  items-center  flex xl:space-x-32  ">
        ...
        {/* links */}
        <div className={`lg:inline-block xl:space-x-2 relative ${ navbar ? 'block ' : 'hidden'}`}  >
          {navbar?<div  className="w-72 ml-20  mt-5 absolute ">{
          navigationRoutes.map((singleRoute) => {//lg<
            return (
              <div>
        ...
        <div className="lg:hidden">
                <button
                  ...
                  {navbar?
                  (
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-darkGreen"
                    viewBox="0 0 20 20"
                    fill="currentColor">
                    <path
                      fillRule="evenodd"
