  ...
  const handleAddMultiImage = (e) => {
    ...
    if (
      ...
      if (propertyDetils.multiImage) {
        ...
        // if multiImage is empty add images
      } else {
        setData({
          ...propertyDetils,
          multiImage: newFiles,
      ...
      <div className="flex flex-col items-center gap-4 justify-between">
        ...
        >
          ...
          <div className="relative  max-w-[250px] max-h-[250px]  overflow-hidden">
            ...
            {!propertyDetils.mainImage && propertyDetils.thumbnail && (
              <>
                <img
                  className="w-full h-full object-cover  rounded-lg"
                  src={propertyDetils.thumbnail}
                />
                <MdOutlineRemoveCircle
                  className="absolute text-center fle text-3xl  top-1 right-1   text-red-500  rounded-full  cursor-pointer"
                  onClick={() => {
                    setData({ ...propertyDetils, thumbnail: null });
                  }}
                />
              </>
            )}
        ...
        >
          ...
          <div className="flex justify-center flex-wrap gap-4 ">
            {/* the images form the server */}
            {propertyDetils.album &&
              propertyDetils.album.map((pic) => (
                <div
                  key={pic._id}
                ...
                >
                  ...
                  <MdOutlineRemoveCircle
                    ...
                    onClick={() => {
                      setData({
                        ...propertyDetils,
                        album: propertyDetils.album.filter(
                          (img) => img._id !== pic._id
                        ),
                      });
                    }}
