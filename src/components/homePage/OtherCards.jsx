...
const OtherCards = () => {
    return (
      <Fragment>
        <div className="flex  p-5  gap-x-3 cursor-pointer justify-around items-center md:w-[45%] w-full bg-gradient-to-b border border-gray-100 from-[#e2f5ff] to-[#8ed9ff00] rounded-lg shadow">
        ...
        <div className="flex p-5  cursor-pointer justify-around items-center md:w-[45%] w-full  bg-gradient-to-b border border-gray-100 from-[#e2f5ff] to-[#8ed9ff00] rounded-lg shadow">
