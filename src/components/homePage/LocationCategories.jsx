...
const LocationCategories = () => {
  ...
  h-36
   overflow-hidden
        ...
        <div className="flex  flex-wrap md:max-w-[80%] gap-[10px] md:justify-normal justify-between ">
          {locations.map((category, index) => (
            <div
              key={index}
              className=" cursor-pointer relative  group md:w-auto w-[48%]"
            >
              <Image
        ...
        <div
          className=" relative   md:mt-0 mt-3  md:block hidden    group justify-center
      "
        >
          <div
            className="
