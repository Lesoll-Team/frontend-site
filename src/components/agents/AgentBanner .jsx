...
const AgentBanner = () => {
  ...
  return (
    <div className=" text-white relative col-span-full py-3  overflow-hidden h-[18dvh] my-3 sm:h-[28dvh]">
      <Image
      ...
      <div className="flex sm:px-10 px-5 justify-center h-full  flex-col overflow-hidden w-full z-10 relative ">
