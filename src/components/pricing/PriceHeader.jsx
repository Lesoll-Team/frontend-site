...
const PriceHeader = () => {
  ...
  return (
    <div className="relative flex sm:min-h-[280px] sm:max-h-[280px] min-h-[130px] max-h-[130px]  justify-center items-center ">
      <Image
        className="w-full object-cover sm:min-h-[280px] sm:max-h-[280px] min-h-[130px] max-h-[130px] "
